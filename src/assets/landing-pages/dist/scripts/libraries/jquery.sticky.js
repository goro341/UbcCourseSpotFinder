		...
		Q = function(i) {
			...
			var r,
				...
				C = {
					...
					stick: function() {
						var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
						u.hasClass(i, p.stickyClass) ||
							(!1 === z.isAttached && z.attach(),
							(C.position = "fixed"),
							(i.style.position = "fixed"),
							(i.style.left = z.offsetLeft + "px"),
							(i.style.width = z.width),
							void 0 === t.bottom
								? (i.style.bottom = "auto")
								: (i.style.bottom = t.bottom + "px"),
							void 0 === t.top
								? (i.style.top = "auto")
								: (i.style.top = t.top + "px"),
							i.classList
								? i.classList.add(p.stickyClass)
								: (i.className += " " + p.stickyClass),
							p.onStart && p.onStart.call(i, Object.assign({}, p)));
					},
					release: function() {
						var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
						if (
							...
							!0 === t.stop ||
								...
								!(
									...
									(void 0 !== t.top &&
										(parseInt(u.getStyle(i, "top")) || 0) === t.top) ||
									(void 0 !== t.bottom &&
										(parseInt(u.getStyle(i, "bottom")) || 0) === t.bottom)
								))
						) {
							!0 === t.stop
								? !0 === z.isAttached && z.detach()
								: !1 === z.isAttached && z.attach();
							var e = t.position || C.css.position;
							(C.position = e),
								(i.style.position = e),
								(i.style.left = !0 === t.stop ? C.css.left : z.positionLeft + "px"),
								(i.style.width = "absolute" !== e ? C.css.width : z.width),
								void 0 === t.bottom
									? (i.style.bottom = !0 === t.stop ? "" : "auto")
									: (i.style.bottom = t.bottom + "px"),
								void 0 === t.top
									? (i.style.top = !0 === t.stop ? "" : "auto")
									: (i.style.top = t.top + "px"),
								i.classList
									? i.classList.remove(p.stickyClass)
								...
								p.onStop && p.onStop.call(i, Object.assign({}, p));
						}
					}
				},
				z = {
					...
					init: function() {
						...
						var e = u.getStyle(i);
						(z.offsetLeft = u.offset(i).left - (parseInt(e.marginLeft) || 0)),
							(z.positionLeft = u.position(i).left),
							(z.width = u.getStyle(i, "width"));
					},
					attach: function() {
				...
				n = function() {
					...
					e.float && (n.float = e.float || "none"),
					e.cssFloat && (n.cssFloat = e.cssFloat || "none"),
					o.MozBoxSizing && (n.MozBoxSizing = o.MozBoxSizing),
					(n.width =
						"auto" !== e.width
							? e.width
							: "border-box" === n.boxSizing || "border-box" === n.MozBoxSizing
							? t.offsetWidth + "px"
							: o.width),
					n)),
						z.init(),
						...
						(l = p.stickTo
							? r
								...
								? $.querySelector(p.stickTo)
								: p.stickTo
							: s),
						(E = (T = function() {
							var t =
									i.offsetHeight +
									(parseInt(C.css.marginTop) || 0) +
									(parseInt(C.css.marginBottom) || 0),
								e = (E || 0) - t;
							return -1 <= e && e <= 1 ? E : t;
						})()),
						(c = (L = function() {
						...
						(d = r ? 0 : u.offset(l).top),
						(y = p.stickTo ? (r ? 0 : u.offset(s).top) : d),
						(m = _.innerHeight),
						(x = i.offsetTop - (parseInt(C.css.marginTop) || 0)),
						(a = p.innerSticker
						...
						(g =
							isNaN(p.top) && -1 < p.top.indexOf("%")
								? (parseFloat(p.top) / 100) * m
								: p.top),
						(h =
							isNaN(p.bottom) && -1 < p.bottom.indexOf("%")
								? (parseFloat(p.bottom) / 100) * m
								: p.bottom),
						(b = a ? a.offsetTop : p.innerTop ? p.innerTop : 0),
						(v =
							isNaN(p.bottomEnd) && -1 < p.bottomEnd.indexOf("%")
								? (parseFloat(p.bottomEnd) / 100) * m
								: p.bottomEnd),
						(S = d - g + b + x);
				},
				...
				R = function() {
					...
					(j = e < N ? "up" : "down"),
						(H = e - N),
						S < (N = e)
							? w + g + (k ? h : 0) - (p.followScroll && k ? 0 : g) <=
							  e +
									E -
									b -
									(m - (S - b) < E - b && p.followScroll && 0 < (t = E - m - b)
										? t
										: 0)
								? C.release({
										position: "absolute",
								...
								? "down" === j
									...
									: Math.ceil(n + b) < 0 && "fixed" === C.position
									? C.release({ position: "absolute", top: o - g - S + b - H })
									: e + g - b <= o && C.stick({ top: g - b })
								: C.stick({ top: g - b })
							: C.release({ stop: !0 });
				},
				A = !1,
				...
				q = function() {
					null !== i.offsetParent && "none" !== u.getStyle(i, "display")
						? (n(), c <= E ? I() : (R(), A || (u.event.bind(_, "scroll", R), (A = !0))))
						: I();
				},
				F = function() {
					(i.style.position = ""),
						...
						(C.css = {}),
						!(C.position = null) === z.isAttached && z.detach();
				},
				M = function() {
					F(), e(), t() ? I() : q();
				},
				D = function() {
					p.onBeforeResize && p.onBeforeResize.call(i, Object.assign({}, p)),
						M(),
						p.onResize && p.onResize.call(i, Object.assign({}, p));
				},
	...
	if (void 0 !== _.jQuery) {
		...
		n.fn.extend({
			hcSticky: function(e, o) {
				return this.length
					? "options" === e
						? n.data(this.get(0), i).options()
						: this.each(function() {
								var t = n.data(this, i);
								t
									? t.triggerMethod(e, o)
									: ((t = new Q(this, e)), n.data(this, i, t));
						  })
					: this;
			}
		});
		...
		t.Helpers = {
			...
			position: function(t) {
				var e = t.offsetParent,
					...
					s = r(t);
				return (
					(o.top += parseInt(i.borderTopWidth) || 0),
					(o.left += parseInt(i.borderLeftWidth) || 0),
					{
			...
			getCascadedStyle: function(t) {
				...
				(o.style.display = "none"),
					...
					o.currentStyle
						? (e = o.currentStyle)
						: c.getComputedStyle && (e = f.defaultView.getComputedStyle(o, null));
				var n = {};
				for (var i in e)
					!isNaN(i) ||
				...
				if (Object.keys(n).length < 3)
					for (var s in ((n = {}), e))
						isNaN(s) ||
							(n[
								e[s].replace(/-\w/g, function(t) {
									return t.toUpperCase().replace("-", "");
								})
							] = e.getPropertyValue(e[s]));
				if (
					(n.margin || "auto" !== n.marginLeft
						? n.margin ||
						  n.marginLeft !== n.marginRight ||
						  n.marginLeft !== n.marginTop ||
						  n.marginLeft !== n.marginBottom ||
						  (n.margin = n.marginLeft)
						: (n.margin = "auto"),
					!n.margin && "0px" === n.marginLeft && "0px" === n.marginRight)
				) {
