...
(function(factory) {
	...
	$.modal.prototype = {
		...
		show: function() {
			...
			this.$elm
				.addClass(`${this.options.modalClass} ${$(this.anchor).data('classnames') ? $(this.anchor).data('classnames') : ''}`)
		...
		showSpinner: function() {
			...
			this.spinner =
				this.spinner || $('<div class="' + this.options.modalClass + '-spinner"></div>').append(this.options.spinnerHtml);
